...
models=(
    ...
    "/scratch/10922/zhsha/workspace/rotation-project/Lucky_RL/fsdp_merged/qwen3-4b-adam-3e-6-trace-constraint-0.0-global_step_200"
    "/scratch/10922/zhsha/workspace/rotation-project/Lucky_RL/fsdp_merged/qwen3-4b-adam-3e-6-trace-constraint-1e-4-global_step_200"
    "/scratch/10922/zhsha/workspace/rotation-project/Lucky_RL/fsdp_merged/qwen3-4b-adam-3e-6-trace-constraint-1e-6-global_step_200"
)

for model_path in "${models[@]}"; do
    model_path=$model_path num_gpus=4 gpu_memory_utilization=0.95 max_length=$((1024 * 4)) bash szz_eval_gen.sh
done
